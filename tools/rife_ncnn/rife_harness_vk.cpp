...
// ncnn RIFE models (rife_v4.14.param/.bin), converted via tools/rife_ncnn.
static const char *RIFE_DIR = "/tmp/rife_models";
// model_dir: a RIFE-only chain has no upscale models to load, so any existing dir is fine.
static const char *MODEL_DIR = "/tmp/rife_models";
